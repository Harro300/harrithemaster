...
const EconomyParioviCalculator: React.FC = () => {
  ...
  const calculate = () => {
    ...
    const lisaovenUretaaniKorkeus = potkupellinKorkeusNum - 121
    const lisaovenUretaaniLeveys = lisaoviLeveys + 41
    ...
    // Potkupelti - Lisäovi
    const lisaovenUlkopeltiKorkeus = potkupellinKorkeusNum - 20 + ulkopeltiKorkeusAdjustment
    const lisaovenUlkopeltiLeveys = lisaoviLeveys + 135 + extraNarrowAdjustment
    const lisaovenSisapeltiKorkeus = potkupellinKorkeusNum - 65 + sisapeltiKorkeusAdjustment
    const lisaovenSisapeltiLeveys = lisaoviLeveys + 135
    ...
    const kayntiovenVaakalista = kayntioviLeveys - 2
    // Lisäoven vaakalista
    const lisaovenVaakalista = lisaoviLeveys - 2
    
    if (numberOfPanes === 1) {
      const ruudunKorkeus = parseFloat(ruudunKorkeudet[1] || potkupellinKorkeus)
      if (ruudunKorkeus) {
        const pystylistaKorkeus = ruudunKorkeus + 38
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
        <h2 style={{ color: colors.primary, fontSize: '1.8rem', fontWeight: '700' }}>Economy Pariovi</h2>
      ...
      <SaveLoadModal
        ...
        currentCalculation={results ? {
          calculatorType: 'Economy Pariovi',
          inputs: {
            kayntiovenLeveys,
            lisaovenLeveys,
            potkupellinKorkeus,
...
export default EconomyParioviCalculator
